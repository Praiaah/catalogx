    ...
    <nav class="navbar">
        <div class="container-fluid">
            <?php
                ...
                if ($row['permissao'] == 0) {
                    echo "<a class='navbar-brand' href=''>SISTEMA CAIXA</a>";
                }
            ?>
    ...
    <section>
        <div class="carrinho">
            ...
            <div class="itens">
                ...
                <div class="itens-main">
                    <div class="item-c">
                        ...
                        <div class="item-c-nome">
                            Cachorro-Quente
                        </div>
                        <div class="item-c-preço">
                            R$8,00
                        </div>
                    </div>
                    <div class="item-c">
            ...
            <div class="resultados">
                <img src="img/resultadosfakekk.png" width="100%" height="100%">
            </div>
        </div>
        <div class="main">
         <table class="t-itens">
